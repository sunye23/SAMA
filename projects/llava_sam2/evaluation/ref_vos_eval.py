...
DATASETS_INFO = {
    'DAVIS': {
        'data_root': '/Sa2VA/reproduce/Sa2VA/data/video_datas/davis17/',
        'image_folder': '/Sa2VA/reproduce/Sa2VA/data/video_datas/davis17/valid/JPEGImages/',
        'expression_file': '/Sa2VA/reproduce/Sa2VA/data/video_datas/davis17/meta_expressions/valid/meta_expressions.json',
        'mask_file': '/Sa2VA/reproduce/Sa2VA/data/video_datas/davis17/valid/mask_dict.pkl',
    },
    'MEVIS': {
        'data_root': '/Sa2VA/reproduce/Sa2VA/data/video_datas/mevis/valid/',
        'image_folder': '/Sa2VA/reproduce/Sa2VA/data/video_datas/mevis/valid/JPEGImages',
        'expression_file': '/Sa2VA/reproduce/Sa2VA/data/video_datas/mevis/valid/meta_expressions.json',
        'mask_file': None,
    },
    'MEVIS_U': {
        'data_root': '/Sa2VA/reproduce/Sa2VA/data/video_datas/mevis/valid_u/',
        'image_folder': '/Sa2VA/reproduce/Sa2VA/data/video_datas/mevis/valid_u/JPEGImages',
        'expression_file': '/Sa2VA/reproduce/Sa2VA/data/video_datas/mevis/valid_u/meta_expressions.json',
        'mask_file': '/Sa2VA/reproduce/Sa2VA/data/video_datas/mevis/valid_u/mask_dict.json',
    },
    'REFYTVOS': {
        'data_root': '/Sa2VA/reproduce/Sa2VA/data/video_datas/rvos/',
        'image_folder': '/Sa2VA/reproduce/Sa2VA/data/video_datas/rvos/valid/JPEGImages/',
        'expression_file': '/Sa2VA/reproduce/Sa2VA/data/video_datas/rvos/meta_expressions/valid/meta_expressions.json',
        'mask_file': None,
    },
    'REVOS': {
        'data_root': '/Sa2VA/reproduce/Sa2VA/data/video_datas/revos/',
        'image_folder': '/Sa2VA/reproduce/Sa2VA/data/video_datas/revos/',
        'expression_file': '/Sa2VA/reproduce/Sa2VA/data/video_datas/revos/meta_expressions_valid_.json',
        'mask_file': None,
    }
}
...
if __name__ == '__main__':
    ...
    for item in tqdm.tqdm(dataloader):
        with torch.no_grad():
            if '<image>' not in item['text_prompt']:
                item['text_prompt'] = "<image>" + '\n' + item['text_prompt']
            original_len = len(item['images'])

            # 模型要求至少5帧，若不足则补齐
            if original_len < 5:
                width, height = item['images'][0].size
                pad_image = Image.fromarray(np.zeros((height, width, 3), dtype=np.uint8))
                item['images'].extend([pad_image] * (5 - original_len))
        ...
        if len(result['prediction_masks']) > 0:
            ...
            if original_len != len(item):
                mask_prediction = mask_prediction[:original_len, :, :]
        else:
