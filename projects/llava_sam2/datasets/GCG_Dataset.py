...
class GCGDataset(Dataset):
    ...
    def dataset_map_fn(self, data_dict):
        data_dict = glamm_refcocog_map_fn(data_dict, self.max_conv_len)
        return data_dict
    ...
    def __getitem__(self, index):
        ...
        # image_token_str_with_context = image_token_str + context_str
        # data_dict = self.replace_image_str(data_dict, image_token_str_with_context)
